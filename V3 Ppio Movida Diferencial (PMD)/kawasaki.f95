...
implicit none
	...
	do k = 1 , average
		...
		call elegir_sitio(nrows,ncols,posx,posy,iniseed,probpos,matriz,k)
		...
		do i=1,MCS*dim
			...
			call CalcDeltaEnergy(nrows,ncols,posx,posy,matriz,alpha,Delta_E,ip,im,iniseed,newposx,newposy)
