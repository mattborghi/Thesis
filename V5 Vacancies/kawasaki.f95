...
implicit none
	...
	write(IDfile1,*) "Tiempo InterPos InterNeg InterPN InterZero IdealR MeasuredR Rho"
	open (UNIT=IDfile2, FILE=InterFile2,ACTION='write',STATUS='replace')
	write(IDfile2,*) "Tiempo InterPos2 InterNeg2 InterPN2 InterZero InterPN InterNZ"
	...
	call Write2File(beta, Magnetization,Magnetization2, &
					Magnetization4,Energy,Energy2,npoints)
	call WriteInteractions(IDfile1,interPos,interNeg,interPN,InterZero,npos,nrows,ncols,npoints)

	!Write the results of interactions v2 in a file
	call WriteInteractionsV2(IDfile2,interPos2,interNeg2,interPN2,InterZero2,InterPZ,InterNZ,nrows,ncols,npoints)
