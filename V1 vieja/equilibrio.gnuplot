...
#Plot
plot fileEnergy u 1:3 t 'Capacidad Calorifica' w p ls 7 pt 6 lc rgb "red"
#Export graph
...
plot fileMagnetization u 1:3 t 'Susceptibilidad' w p ls 7 pt 6 lc rgb "blue"
#Key
set key on top right box
#Label
set xlabel "kT/J"
