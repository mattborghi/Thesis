...
plot(dataL128$Temperatura,dataL128$Cumulant,type='o',pch=18,lty=3,col='red',xlab=c("Temperatura [J/kB]"),ylab=c("Cumulante U_4"))
...
legend(x=1.5,y=0.55,legend=c("L=032","L=064","L=128","L=256","L=512"),col=c('cyan','magenta','red','blue','green'),pch=c(16,17,18,19,20),lty=c(1,2,3,4,5))
dev.off()

pdf(paste(folder,'closeCumulant.pdf',sep='')) # 2.25,2.28
plot(dataL128$Temperatura,dataL128$Cumulant,type='o',pch=18,lty=3,col='red',xlim=c(1.55,1.8),ylim=c(0.2,0.72),xlab=c("Temperatura [J/kB]"),ylab=c("Cumulante U_4"))
grid (NULL,NULL, lty = 6, col = "cornsilk2") 
lines(dataL256$Temperatura,dataL256$Cumulant,type='o',pch=19,lty=4,col='blue')
lines(dataL512$Temperatura,dataL512$Cumulant,type='o',pch=20,lty=5,col='green')
#lines(dataL1024$Temperatura,dataL1024$Cumulant,type='o',pch=19,lty=4,col='purple')
...
lines(dataL64$Temperatura,dataL64$Cumulant,type='o',pch=17,lty=2,col='magenta')
#legend(x=0.225,y=0.55,legend=c("L=032","L=064","L=128","L=256","L=512","L=1024","L=2048"),col=c('cyan','magenta','red','blue','green','purple','seagreen1'),pch=c(16,17,18,19,20,19,20),lty=c(1,2,3,4,5,4,5))
legend(x=1.55,y=0.5,legend=c("L=032","L=064","L=128","L=256","L=512"),col=c('cyan','magenta','red','blue','green'),pch=c(16,17,18,19,20),lty=c(1,2,3,4,5))
dev.off()

pdf(paste(folder,'closerCumulant.pdf',sep='')) # 2.25,2.28
par.default <- par(no.readonly=TRUE)
# create the main graph
par(mar=c(5,6,1,1))
plot(dataL128$Temperatura,dataL128$Cumulant,type='o',pch=18,lty=3,col='red',xlim=c(1.69,1.71),ylim=c(0.2,0.72),xlab=c("Temperatura [J/kB]"),ylab=c("Cumulante U_4"))
grid (NULL,NULL, lty = 6, col = "cornsilk2") 
lines(dataL256$Temperatura,dataL256$Cumulant,type='o',pch=19,lty=4,col='blue')
lines(dataL512$Temperatura,dataL512$Cumulant,type='o',pch=20,lty=5,col='green')
#lines(dataL1024$Temperatura,dataL1024$Cumulant,type='o',pch=19,lty=4,col='purple')
...
lines(dataL64$Temperatura,dataL64$Cumulant,type='o',pch=17,lty=2,col='magenta')
#legend(x=0.225,y=0.55,legend=c("L=032","L=064","L=128","L=256","L=512","L=1024","L=2048"),col=c('cyan','magenta','red','blue','green','purple','seagreen1'),pch=c(16,17,18,19,20,19,20),lty=c(1,2,3,4,5,4,5))
legend(x=1.693,y=0.58,legend=c("L=032","L=064","L=128","L=256","L=512"),col=c('cyan','magenta','red','blue','green'),pch=c(16,17,18,19,20),lty=c(1,2,3,4,5))
...
par(fig=c(0.3,0.6,0.20,0.54)) # fig shrinks and places relative to figure region
...
#legend(x=0.225,y=0.55,legend=c("L=032","L=064","L=128","L=256","L=512","L=1024","L=2048"),col=c('cyan','magenta','red','blue','green','purple','seagreen1'),pch=c(16,17,18,19,20,19,20),lty=c(1,2,3,4,5,4,5))
legend(x=1.55,y=-1.45,legend=c("L=032","L=064","L=128","L=256","L=512"),col=c('cyan','magenta','red','blue','green'),pch=c(16,17,18,19,20),lty=c(1,2,3,4,5))
dev.off()
...
plot(dataL512$Temperatura,dataL512$SusceptAbs/(512^2),xlim=c(1.5,1.8),ylim=c(0,max(dataL32$SusceptAbs/(32^2))+0.002),type='o',pch=20,lty=5,col='green',xlab=c("Temperatura [J/kB]"),ylab=c("Susceptibilidad por espín /L^2"))
grid (NULL,NULL, lty = 6, col = "cornsilk2") 
...
#legend(x=0.225,y=0.55,legend=c("L=032","L=064","L=128","L=256","L=512","L=1024","L=2048"),col=c('cyan','magenta','red','blue','green','purple','seagreen1'),pch=c(16,17,18,19,20,19,20),lty=c(1,2,3,4,5,4,5))
legend(x=1.5,y=0.02,legend=c("L=032","L=064","L=128","L=256","L=512"),col=c('cyan','magenta','red','blue','green'),pch=c(16,17,18,20,20),lty=c(1,2,3,4,5))
dev.off()
...
maxy <- max(dataL128$HeatCapacity*128^(exte),dataL512$HeatCapacity*512^(exte),dataL256$HeatCapacity*256^(exte),dataL64$HeatCapacity*64^(exte),dataL32$HeatCapacity*32^(exte))
plot(128*(dataL128$Temperatura-Tc)/Tc,dataL128$HeatCapacity*128^(exte),xlim=c(-4,4),ylim=c(0.3,maxy+0.025),type='p',pch=18,lty=3,col='red',xlab=c("L*(T-Tc)/Tc"),ylab=c("c*L^(-0.21)"))
grid (NULL,NULL, lty = 6, col = "cornsilk2") 
...
#legend(x=0.225,y=0.55,legend=c("L=032","L=064","L=128","L=256","L=512","L=1024","L=2048"),col=c('cyan','magenta','red','blue','green','purple','seagreen1'),pch=c(16,17,18,19,20,19,20),lty=c(1,2,3,4,5,4,5))
legend(x=2,y=0.6,legend=c("L=032","L=064","L=128","L=256","L=512"),col=c('cyan','magenta','red','blue','green'),pch=c(16,17,18,19,20),lty=c(1,2,3,4,5))
dev.off()

pdf(paste(folder,'CapacidadCalorifica.pdf',sep=''))
plot(dataL512$Temperatura,dataL512$HeatCapacity,type='o',pch=20,lty=5,col='green',ylim=c(0.6,max(dataL256$HeatCapacity)+0.1),xlim=c(1.5,1.8),xlab=c("Temperatura [J/kB]"),ylab=c("Capacidad Calorifica por espín"))
grid (NULL,NULL, lty = 6, col = "cornsilk2") 
...
#legend(x=0.225,y=0.55,legend=c("L=032","L=064","L=128","L=256","L=512","L=1024","L=2048"),col=c('cyan','magenta','red','blue','green','purple','seagreen1'),pch=c(16,17,18,19,20,19,20),lty=c(1,2,3,4,5,4,5))
legend(x=1.5,y=1.8,legend=c("L=032","L=064","L=128","L=256","L=512"),col=c('cyan','magenta','red','blue','green'),pch=c(16,17,18,19,20),lty=c(1,2,3,4,5))
dev.off()


pdf(paste(folder,'closeCapacidadCalorifica.pdf',sep=''))
maxy <- max(dataL128$HeatCapacity,dataL512$HeatCapacity,dataL256$HeatCapacity,dataL64$HeatCapacity,dataL32$HeatCapacity)
plot(dataL512$Temperatura,dataL512$HeatCapacity,type='o',pch=20,lty=5,col='green',ylim=c(0,maxy+0.1),xlim=c(1.5,1.8),xlab=c("Temperatura [J/kB]"),ylab=c("Capacidad Calorifica por espín"))
grid (NULL,NULL, lty = 6, col = "cornsilk2") 
lines(dataL256$Temperatura,dataL256$HeatCapacity,type='o',pch=19,lty=4,col='blue')
lines(dataL128$Temperatura,dataL128$HeatCapacity,type='o',pch=18,lty=3,col='red')
#lines(dataL1024$Temperatura,dataL1024$HeatCapacity,type='o',pch=19,lty=4,col='purple')
...
lines(dataL64$Temperatura,dataL64$HeatCapacity,type='o',pch=17,lty=2,col='magenta')
#legend(x=0.225,y=0.55,legend=c("L=032","L=064","L=128","L=256","L=512","L=1024","L=2048"),col=c('cyan','magenta','red','blue','green','purple','seagreen1'),pch=c(16,17,18,19,20,19,20),lty=c(1,2,3,4,5,4,5))
legend(x=1.55,y=2.5,legend=c("L=032","L=064","L=128","L=256","L=512"),col=c('cyan','magenta','red','blue','green'),pch=c(16,17,18,19,20),lty=c(1,2,3,4,5))
dev.off()
